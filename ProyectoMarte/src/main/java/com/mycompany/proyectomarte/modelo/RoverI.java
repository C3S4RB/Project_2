...
public interface RoverI {
    ...
    void dirigirse();///le indica al robot que debe dirigirse a la posición x,y del mapa. El robot debe de forma automática encontrar la ruta para llegar al sitio en x,y y luego dirigirse a eselugar 
